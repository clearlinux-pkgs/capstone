...
Version  : 5.0.6
Release  : 9
URL      : https://github.com/aquynh/capstone/archive/5.0.6/capstone-5.0.6.tar.gz
Source0  : https://github.com/aquynh/capstone/archive/5.0.6/capstone-5.0.6.tar.gz
...
%prep
%setup -q -n capstone-5.0.6
cd %{_builddir}/capstone-5.0.6
pushd ..
cp -a capstone-5.0.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744300968
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcapstone.so.5.0.6
/usr/lib64/libcapstone.so.5
/usr/lib64/libcapstone.so.5.0.6
