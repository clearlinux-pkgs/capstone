...
Source0  : https://github.com/aquynh/capstone/archive/4.0.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573355103
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/capstone-4.0.1/LICENSE.TXT %{buildroot}/usr/share/package-licenses/capstone/861af24907e399e873920dbbff1ea1dd73a9ba35
cp %{_builddir}/capstone-4.0.1/LICENSE_LLVM.TXT %{buildroot}/usr/share/package-licenses/capstone/afc034c0ae47cbd47a99c6c5992d846511bb33ad
cp %{_builddir}/capstone-4.0.1/bindings/python/LICENSE.TXT %{buildroot}/usr/share/package-licenses/capstone/861af24907e399e873920dbbff1ea1dd73a9ba35
cp %{_builddir}/capstone-4.0.1/suite/regress/LICENSE %{buildroot}/usr/share/package-licenses/capstone/7de9d56eea42f5bbbba6fff880d912f2c9c3a45d
pushd clr-build
%make_install
popd
